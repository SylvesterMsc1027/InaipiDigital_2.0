import React, { useEfagentTransferIdfect, useEffect, useState } from "react";
...
const Conferanceagentmodel = ({ show, close,chatid,chat ,setConferenceNotificationVal,setConferenceNotification}) => {
      ...
      if (chat.is_customer_disconnected) {
        ...
        let message_to_pass;
          ...
          message_to_pass =
            ...
            " and " +
            selected_name;
          setConferenceNotificationVal(message_to_pass);
          ...
          if (data.data.status) {
            ...
            handleTransferClose();
            setConferenceNotification(true);
    ...
    <>
      <Modal show={show} size="md" onHide={close} >
        <Modal.Header  style={{ backgroundColor: '#0b3363', color: '#fff' }}>
          ...
          }}>Conferance To Agent</Modal.Title>
